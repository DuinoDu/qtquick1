/****************************************************************************
** Meta object code from reading C++ file 'qwidgets.h'
**
...
#error "The header file 'qwidgets.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_MyPushButton[] = {
    "MyPushButton\0\0clicked(bool)\0textChanged()\0"
    "QString\0text\0"
};
...
const QMetaObject MyPushButton::staticMetaObject = {
    { &QGraphicsProxyWidget::staticMetaObject, qt_meta_stringdata_MyPushButton,
...
// SIGNAL 0
void MyPushButton::clicked(bool _t1)
{
